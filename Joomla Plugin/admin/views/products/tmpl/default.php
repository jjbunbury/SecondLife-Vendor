...
<?php
	JToolBarHelper::preferences('com_slvendor', '360');
	JToolBarHelper::title(   JText::_( 'PRODUCTS MANAGER' ), 'generic.png' );
	JToolBarHelper::publishList();
	JToolBarHelper::unpublishList();
	JToolBarHelper::deleteList(JText::_( 'DO YOU REALLY WANT TO DELETE PRODUCTS ?' ));
...
<div id="editcell">
	...
	{
		$row = &$this->items[$i];
		$link 	= JRoute::_( 'index.php?option=com_slvendor&controller=products&task=edit&cid[]='. $row->id );
		$checked 	= JHTML::_('grid.checkedout',   $row, $i );
		$published 	= JHTML::_('grid.published', $row, $i );
		$ordering = ($this->lists['order'] == 'a.ordering');
		$row->cat_link 	= JRoute::_( 'index.php?option=com_categories&section=com_slvendor&task=edit&type=other&cid[]='. $row->catid );
		?>
