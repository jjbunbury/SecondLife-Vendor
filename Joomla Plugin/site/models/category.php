 ...
 * @since 1.5
 */
class SlvendorModelCategory extends JModel
{
	/**
	 * Category id
	 *
	...
	function __construct()
	{
		...
		$this->setState('limit', $mainframe->getUserStateFromRequest('com_slvendor.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
	...
	/**
	 * Method to get a pagination object of the contact items for the category
	 *
	 * @access public
	 * @return integer
	 */
	...
	function _buildQuery()
	{
		...
		// We need to get a list of all contacts in the given category
		$query = 'SELECT *' .
